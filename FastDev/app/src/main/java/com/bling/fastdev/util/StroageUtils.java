...
public class StroageUtils {
    ...
    /**
     * * 清除本应用内部缓存(/data/data/com.xxx.xxx/databases) * *
     *
     * @param context
     */
    ...
    public static Boolean cleanExternalCache(Context context) {
        if (Environment.getExternalStorageState().equals(
            ...
            deleteFilesByDirectory(new File(context.getExternalCacheDir()+"/xBitmapCache"));//清除Bitmap文件夹下的缓存文件
    ...
    public static Boolean clearAllCache(Context context) {
        ...
        clearExternal = cleanExternalCache(context);
